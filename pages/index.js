  ...
  return (
    <div className="min-h-screen bg-ink text-[#e7e9ee] font-body relative overflow-hidden">
      ...
      <div className="relative">
        <Header githubStars={githubStars} onHowItWorks={() => setHowOpen(true)} />
        <main className="max-w-6xl mx-auto px-5 md:px-8 pt-4 md:pt-6 pb-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.88fr_1.12fr] gap-4 lg:gap-0 items-center min-h-[500px] lg:min-h-[525px]">
            <section className="max-w-xl z-10">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3 text-xs text-[#7f8595]"><span className="text-[#6fbf73]">●</span><span className="font-display text-lg text-[#e7e9ee]">{cardsRated.toLocaleString()}</span><span>cards rated</span><span className="text-[#3c4250]">|</span><button type="button" onClick={() => setHowOpen(true)} className="hover:text-[#e7e9ee] transition">how it works ↗</button></div>
            </section>
