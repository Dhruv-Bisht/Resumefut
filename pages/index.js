...
=======
  {
    ...
    tier: 'goldtier',
    statList: [
      { key: 'exp', label: 'EXP', value: 98 },
      { key: 'skl', label: 'SKL', value: 96 },
      { key: 'led', label: 'LED', value: 92 },
      { key: 'imp', label: 'IMP', value: 97 },
      { key: 'edu', label: 'EDU', value: 91 },
      { key: 'ver', label: 'VER', value: 88 },
    ],
    photo: '/assets/face-1.png',
    flag: '🇺🇸',
  },
  {
    name: 'ENGINEER',
    ...
    tier: 'goldtier',
    statList: [
      { key: 'exp', label: 'EXP', value: 82 },
      { key: 'skl', label: 'SKL', value: 94 },
      { key: 'led', label: 'LED', value: 78 },
      { key: 'imp', label: 'IMP', value: 91 },
      { key: 'edu', label: 'EDU', value: 88 },
      { key: 'ver', label: 'VER', value: 86 },
    ],
    photo: '/assets/face-2.png',
    flag: '🇮🇳',
  },
  {
    name: 'BUILDER',
    ...
    tier: 'goldtier',
    statList: [
      { key: 'exp', label: 'EXP', value: 76 },
      { key: 'skl', label: 'SKL', value: 87 },
      { key: 'led', label: 'LED', value: 83 },
      { key: 'imp', label: 'IMP', value: 90 },
      { key: 'edu', label: 'EDU', value: 79 },
      { key: 'ver', label: 'VER', value: 81 },
    ],
    photo: '/assets/face-3.png',
    flag: '🇬🇧',
  },
...
function Modal({ title, children, onClose, wide = false }) {
  ...
  return (
<<<<<<< HEAD
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-sm" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
      <div className={`${wide ? 'max-w-3xl' : 'max-w-xl'} w-full max-h-[92vh] overflow-y-auto bg-[#11151e] border border-hairline rounded-2xl shadow-2xl`}>
        <div className="sticky top-0 z-10 flex items-center justify-between px-4 sm:px-5 py-3.5 sm:py-4 bg-[#11151e]/95 backdrop-blur border-b border-hairline">
      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-5 py-4 bg-[#11151e]/95 backdrop-blur border-b border-hairline">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-full border border-hairline text-[#9aa0b0] hover:text-white hover:border-gold/50 transition"
            aria-label="Close"
          >
            ×
          </button>
...
=======
          <p className="font-display font-bold text-2xl tracking-wide">
            WE DON'T JUST RATE YOU.{' '}
            <span className="text-gold">WE READ YOU.</span>
          </p>

          <p className="mt-3 text-[#aeb4c1] leading-relaxed">
            Six signals are read from your resume and weighed against
            each other to find your shape. That shape becomes your card
            — so two people with similar numbers can still walk out
...
<<<<<<< HEAD
        filter: (node) => !node?.dataset?.captureControl,
      });
...
<<<<<<< HEAD
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-5 md:px-8 py-3 md:py-4">
        ...
        <main className="max-w-6xl mx-auto px-5 md:px-8 py-3 md:py-4">
          {!derbyOpen && (
            <div className="flex flex-col md:flex-row md:items-start gap-4 mb-2">
              <div className="w-16 h-16 rounded-xl bg-panel border border-hairline flex flex-col items-center justify-center shrink-0">
                <span className="font-display font-bold text-xl leading-none">
                  {card.overall}
                </span>

                <span className="text-[8px] tracking-[0.15em] text-[#9aa0b0] mt-1">
              ...
              <div className="flex-1 min-w-0">
                {editingName ? (
                  <input
                    ...
                    className="font-display font-bold text-2xl md:text-3xl tracking-wide bg-transparent border-b border-gold/60 focus:outline-none w-full"
                  />
                ) : (
                  <h1
                    className="font-display font-bold text-2xl md:text-3xl tracking-wide truncate cursor-text"
                    title="Click to edit"
                    onClick={() =>
                      setEditingName(true)
                    }
                  >
                    ...
                    <span className="text-[#565c6b] text-sm align-middle ml-2 font-body font-normal">
                      edit ✎
                    </span>
                  </h1>
                )}
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2 text-sm">
                  ...
                  <span className="text-[#c7cbd6]">
                    {card.archetype}
                  </span>

                  <span className="text-[#565c6b]">
                    ·
                  </span>
                  ...
                  {card.sources?.github && (
                    <span className="text-[#6fbf73]">
                      GitHub linked
                    </span>
                  )}

                  {card.sources?.leetcode && (
                    <span className="text-[#6fbf73]">
                      LeetCode linked
                    </span>
                  )}
          ...
          {derbyOpen ? (
            <section className="py-1">
              <div className="text-center max-w-xl mx-auto mb-6">
                <p className="text-xs tracking-[0.2em] uppercase text-[#6fbf73] mb-2">
                  Your card stays locked in
                </p>
                ...
                <p className="mt-2 text-[#9aa0b0] text-sm">
                  Keep your card on the pitch, scout an
                  opponent, then customize their photo and
                  nationality before the battle.
                </p>
              </div>

              {!derbyOpponent?.card ? (
                <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-5 items-start max-w-4xl mx-auto">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="w-full mt-2 border border-hairline text-[#c7cbd6] font-medium py-2.5 rounded-md"
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <div className="max-w-5xl mx-auto">
                  <div className="text-center mb-5">
                    <p className="text-xs uppercase tracking-[0.18em] text-[#6fbf73]">
                      Opponent scouted
                    </p>

                    <h2 className="font-display font-bold text-2xl tracking-wide mt-1">
                      CUSTOMIZE THE OPPONENT CARD
                    </h2>

                    <p className="text-sm text-[#9aa0b0] mt-1">
                      Add a small photo and nationality.
                      Both will stay on the card during
                      the derby.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-center gap-6">
                    <div>
                      <PlayerCard
                        card={{
                          ...derbyOpponent.card,
                          photo:
                            derbyOpponent.card.photo ||
                            '',
                          flag:
                            derbyOpponent.card.flag ||
                            '',
                        }}
                        editable
                        onPhotoChange={(value) =>
                    ...
                    <div className="w-full max-w-sm bg-panel border border-hairline rounded-xl p-5">
                      <div className="text-xs uppercase tracking-[0.16em] text-gold">
                        Card identity
                      </div>

                      <p className="text-sm text-[#c7cbd6] mt-2">
                        Customize the opponent before the
                        battle. These controls are also
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-4">
                        <button
                          ...
                          onClick={() =>
                            document
                              .querySelector(
                                '[data-derby-photo-input]'
                              )
                              ?.click()
                          }
                          className="border border-hairline rounded-md px-3 py-2 text-sm text-[#c7cbd6] hover:border-gold/60"
                        >
                          📷 Add photo
                        </button>
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setDerbyBattleStarted(
                            true
                          )
                        }
                        className="w-full mt-5 bg-gold text-[#20180a] font-display font-semibold tracking-wide py-3 rounded-md"
                      >
                        ⚔️ Battle this card
                      </button>
                ...
                >
                  <div className="p-4 md:p-7">
                    <div className="text-center mb-4">
                      ...
                      <p className="text-sm text-[#9aa0b0] mt-1">
                        {battle?.winsA} categories to{' '}
                        {battle?.winsB}
                      </p>
                    </div>

                    <div className="flex flex-col lg:flex-row items-center justify-center gap-0 mb-5">
                      <div
                        className={
                          battle?.overallWinner ===
                            'a'
                      ...
                      <div className="font-display font-bold text-2xl text-[#565c6b] px-2">
                        VS
                      </div>
                    ...
                    <div className="max-w-xl mx-auto bg-panel/90 border border-hairline rounded-lg p-5">
                      {battle?.rows.map((row) => (
                        <div
                          key={row.key}
                        ...
                        >
                          ...
                          <span className="text-xs text-[#9aa0b0] tracking-wide">
                            {row.label}
                          </span>
                      ...
                      <div className="flex items-center justify-between py-2 mt-1 border-t border-hairline">
                        <span className="w-12 text-xl font-display font-bold">
                          {card.overall}
                        </span>

                        <span className="text-xs tracking-[0.15em] text-[#9aa0b0]">
                          OVERALL
                        </span>

                        <span className="w-12 text-xl font-display font-bold text-right">
                          {
                            derbyOpponent.card
                              .overall
                          }
                    ...
                    <div className="text-center mt-5">
                      <button
                        ...
                        className="bg-gold text-[#20180a] font-display font-semibold tracking-wide px-5 py-2.5 rounded-md"
                      >
                        ⭳ Download Derby Result
                      </button>
                      ...
                      <div className="mt-2">
                        <button
                          ...
                          className="border border-gold/50 text-gold font-display font-semibold tracking-wide px-5 py-2.5 rounded-md"
                        >
                          Edit opponent identity
                        </button>
                        ...
                        <button
                          ...
                          className="ml-2 bg-gold text-[#20180a] font-display font-semibold tracking-wide px-5 py-2.5 rounded-md"
                        >
                          Battle another resume
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[230px_1fr_270px] gap-4 items-start">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 mt-2">
                  <button
                    ...
                    className="flex items-center gap-2 bg-gold text-[#20180a] font-display font-semibold tracking-wide px-5 py-2 rounded-md"
                  >
                    ⭳ Download
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 border border-gold/60 text-gold font-display font-semibold tracking-wide px-4 py-2 rounded-md"
                  >
                    ⚔️ Derby Mode
                  </button>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-9 h-9 flex items-center justify-center border border-hairline rounded-md text-[#c7cbd6]"
                  >
                    𝕏
                  </a>
...
<<<<<<< HEAD
        <main className="max-w-6xl mx-auto px-4 sm:px-5 md:px-8 pt-4 md:pt-6 pb-8 sm:pb-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.88fr_1.12fr] gap-8 lg:gap-0 items-center min-h-0 lg:min-h-[525px]">
            <section className="w-full max-w-xl z-10 mx-auto lg:mx-0">
              <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-hairline bg-panel/70 px-4 py-2 text-xs tracking-[0.18em] uppercase text-[#c7cbd6]"><span className="text-gold">RESUME</span> × <span className="text-[#6fbf73]">WORLD CUP</span></div>
              <h1 className="mt-5 font-display font-bold text-[3.5rem] sm:text-6xl md:text-8xl leading-[0.86] tracking-wide">GET<br />SCOUTED<span className="text-gold">.</span></h1>
              <p className="mt-4 sm:mt-5 text-base sm:text-lg md:text-xl text-[#d5d8e0] leading-relaxed max-w-lg">Your resume, turned into a World-Cup-style player card rated out of 99.</p>
              <button type="button" onClick={() => { setError(''); setUploadOpen(true); }} className="mt-5 sm:mt-6 w-full max-w-xl bg-panel border border-hairline rounded-2xl p-2 flex items-center gap-2 shadow-2xl shadow-black/20 text-left hover:border-gold/40 transition group"><span className="flex-1 px-4 text-sm md:text-base text-[#9aa0b0] font-mono"><span className="text-[#596173]">▣</span> resume.pdf or paste text</span><span className="bg-signal text-white font-display font-semibold tracking-wide px-7 py-3.5 rounded-xl group-hover:brightness-110 transition">SCOUT →</span></button>
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-3 text-xs text-[#7f8595]"><span className="text-[#6fbf73]">●</span><span className="font-display text-lg text-[#e7e9ee]">{cardsRated.toLocaleString()}</span><span>cards rated</span></div>
            </section>
        ...
        <main className="max-w-6xl mx-auto px-5 md:px-8 pt-4 md:pt-6 pb-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.88fr_1.12fr] gap-4 lg:gap-0 items-center min-h-[500px] lg:min-h-[525px]">
            <section className="max-w-xl z-10">
              ...
              <h1 className="mt-5 font-display font-bold text-6xl md:text-8xl leading-[0.86] tracking-wide">
                GET
                <br />
                SCOUTED
              ...
              <p className="mt-5 text-lg md:text-xl text-[#d5d8e0] leading-relaxed max-w-lg">
                Your resume, turned into a World-Cup-style player
                card rated out of 99.
              </p>
              ...
              <button
                ...
                className="mt-6 w-full max-w-xl bg-panel border border-hairline rounded-2xl p-2 flex items-center gap-2 shadow-2xl shadow-black/20 text-left hover:border-gold/40 transition group"
              >
                <span className="flex-1 px-4 text-sm md:text-base text-[#9aa0b0] font-mono">
                  <span className="text-[#596173]">
                    ▣
                  </span>{' '}
                  resume.pdf or paste text
                </span>

                <span className="bg-signal text-white font-display font-semibold tracking-wide px-7 py-3.5 rounded-xl group-hover:brightness-110 transition">
                  SCOUT →
                </span>
              </button>

              <div className="flex flex-wrap items-center gap-3 mt-3 text-xs text-[#7f8595]">
                <span className="text-[#6fbf73]">
                  ●
                </span>

                <span className="font-display text-lg text-[#e7e9ee]">
                  {cardsRated.toLocaleString()}
                </span>

                <span>cards rated</span>
              </div>
            </section>

            <section
              className="relative h-[470px] hidden lg:block"
              aria-label="Sample ResumeFUT cards"
            >
>>>>>>> 04ed909a3289644389fdf556a8b8c3a31b1b0601
