...
export default function Home() {
  ...
  function reset() {
    setCard(null); setStatus('idle'); setError(''); setDisplayName(''); setPhoto(''); setFlag(''); setResumeText(''); setDerbyOpen(false); setDerbyOpponent(null); setDerbyStatus('idle'); setDerbyError('');
  }
  ...
  async function runDerby() {
    ...
    try {
      ...
      setDerbyOpponent({ ...derbyOpponent, card: opponent }); setDerbyStatus('done'); recordCardRated();
